Kairo English frequency lookup

Derived from wordfreq 3.1.1 by Robyn Speer: https://github.com/rspeer/wordfreq
Kairo filters the first 30,000 entries to English alphabetic words and contractions,
exports integer hundredths of Zipf frequency, sorts and gzip-compresses the table.
This adapted data is licensed under CC BY-SA 4.0:
https://creativecommons.org/licenses/by-sa/4.0/
Source and reproducible exporter: scripts/export-reading-frequency.py.
No wordfreq runtime code is bundled. SUBTLEX, by Marc Brysbaert et al., is freely available data.

Upstream attribution follows:
