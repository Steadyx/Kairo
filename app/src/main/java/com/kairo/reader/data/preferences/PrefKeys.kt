...
internal object PrefKeys {
    ...
    val difficultWordSupport = doublePreferencesKey("difficult_word_support")
    val showDifficultWordParts = booleanPreferencesKey("show_difficult_word_parts")
    val phraseBreathingRoomMs = longPreferencesKey("phrase_breathing_room_ms")
