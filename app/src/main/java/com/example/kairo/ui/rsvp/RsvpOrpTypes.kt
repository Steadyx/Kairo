...
internal data class OrpPivotRange(val start: Int, val end: Int, val safePivotIndex: Int,)

internal data class OrpLayoutResult(val pivotIndex: Int, val translationX: Float, val guideBias: Float,)

internal data class PivotAlignment(val pivotX: Float, val translationX: Float,)
