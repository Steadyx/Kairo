...
class RsvpFrameRepositoryImpl(
    ...
    private val cache = object : LinkedHashMap<CacheKey, RsvpFrameSet>(12, 0.75f, true) {
        override fun removeEldestEntry(eldest: MutableMap.MutableEntry<CacheKey, RsvpFrameSet>?): Boolean {
            return size > MAX_CACHED_FRAME_SETS
        }
    }
    ...
    override suspend fun getFrames(bookId: BookId, chapterIndex: Int, config: RsvpConfig): RsvpFrameSet {
        ...
        val frames = withContext(engineDispatcher) {
